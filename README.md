...
- [Live Demo Link](https://ameerhamzakhalid.github.io/leaderboard/) -->
...
```sh
  cd my-folder
  git clone https://github.com/ameerhamzakhalid/leaderboard.git
```
...
Feel free to check the [issues page](https://github.com/ameerhamzakhalid/leaderboard/issues).
